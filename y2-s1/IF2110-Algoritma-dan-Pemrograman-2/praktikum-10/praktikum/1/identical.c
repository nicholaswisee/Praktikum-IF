...
boolean isIdentical(BinTree P, BinTree Q) {
    if (isBinary(P) && isBinary(Q)) {
        return (ROOT(P) == ROOT(Q)) && (isIdentical(LEFT(P), LEFT(Q))) && (isIdentical(RIGHT(P), RIGHT(Q)));
    } else if (isUnerLeft(P) && isUnerLeft(Q)) {
        return (ROOT(P) == ROOT(Q)) && (isIdentical(LEFT(P), LEFT(Q)));
    } else if (isUnerRight(P) && isUnerRight(Q)) {
        return (ROOT(P) == ROOT(Q)) && (isIdentical(RIGHT(P), RIGHT(Q)));
    } else if (isOneElmt(P) && isOneElmt(Q)) {
