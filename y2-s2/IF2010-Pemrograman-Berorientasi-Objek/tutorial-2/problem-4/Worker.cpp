...
Worker::Worker(const std::string &name, int power, const std::string &dimension,
    ...
    : Creature(name, power, dimension), workHours(workHours),
      specialSkill(specialSkill) {}

Worker::~Worker() = default;

int Worker::getWorkHours() const { return workHours; }

const std::string &Worker::getSpecialSkill() const { return specialSkill; }
