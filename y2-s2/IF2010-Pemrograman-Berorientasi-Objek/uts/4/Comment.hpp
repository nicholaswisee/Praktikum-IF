/**
 * @file Comment.hpp
 * @brief Mendefinisikan kelas Comment yang merepresentasikan pesan chat dari
 * penonton.
 */
 ...
 * * Kelas ini bertugas menyimpan informasi tentang siapa pengirim chat, status
 * VIP pengirim, dan isi pesan yang sudah dipecah menjadi kumpulan kata untuk
...
class Comment {
  private:
    ...
    std::vector<std::string>
        words_; /// Kumpulan kata dari isi komentar yang sudah dipisah
  ...
  public:
     ...
     * @param words Isi pesan yang sudah dipisah per kata ke dalam sebuah
     * vector.
     */
